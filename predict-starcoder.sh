...
python tools/quality_classifier/predict.py \
    /mnt/tmp/apps/cmss-yangjiandong/data/train/starcoder-python/starcoder-python-filter.parquet \
    /mnt/tmp/apps/cmss-yangjiandong/data/train/starcoder-python/score/starcoder-python-filter.parquet \
    --model code \
